        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <button
              ...
              className="md:hidden p-2 rounded-md text-white hover:bg-red-700 focus:outline-none flex items-center justify-center h-10"
            >
              <Menu size={24} />
            </button>
            <img
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="p-2 rounded-full text-white hover:bg-red-700 focus:outline-none relative group"
              >
                <Bell size={24} className="group-hover:animate-bounce" />
                {notificationCount > 0 && (
                  <span className="absolute -top-1 -right-1 inline-flex items-center justify-center h-5 w-5 text-xs font-bold leading-none text-red-600 bg-white rounded-full border-2 border-red-600">
                    {notificationCount}
                  </span>
                )}
              </button>
